...
- **Điểm sẵn sàng:** Đồng bộ trực tiếp dữ liệu phần trăm (%) với mục **Độ sẵn sàng thi** trên Sidebar.
- **Chuỗi học tập (Streak):** Ghi nhận số ngày liên tiếp người dùng có đăng nhập và tham gia học tập trên hệ thống.
- **Chủ đề đã nắm:** 
  - **Dữ liệu:** Kết hợp từ số lượng mục tiêu trong **Kế hoạch học** và kết quả bài làm ở phần **Kiểm tra**.
  - **Mục đích:** Giúp người dùng nắm được tổng quan mình đang theo bao nhiêu chủ đề và đã hoàn thành vững chắc bao nhiêu chủ đề.
- **Tính nhất quán học tập (Activity Heatmap):** 
  - Biểu đồ nhiệt thống kê tần suất học tập theo từng ngày trong tháng.
  - Hệ thống sẽ ghi nhận bắt đầu từ lúc người dùng đăng nhập và có hoạt động học trong ngày. Tần suất hoạt động càng cao, màu sắc hiển thị tại ngày đó trên biểu đồ sẽ càng đậm.
